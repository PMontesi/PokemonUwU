...
ADD CONSTRAINT ID_ENTRENADOR_MOCHILA_FK
...
CREATE VIEW POKEMON_EQUIPO AS
SELECT P.*, PD.TIPO1, PD.TIPO2, PD.IMAGEN_DELANTE, PD.IMAGEN_DETRAS, PD.IMAGEN_DETRAS_F, PD.SONIDO
FROM POKEMON P
INNER JOIN POKEDEX PD ON P.NUM_POKEDEX = PD.NUM_POKEDEX
WHERE P.CAJA = 0;


CREATE VIEW POKEMON_CAJA AS
SELECT P.*, PD.TIPO1, PD.TIPO2, PD.IMAGEN_DELANTE, PD.IMAGEN_DETRAS, PD.IMAGEN_DETRAS_F, PD.SONIDO
FROM POKEMON P
INNER JOIN POKEDEX PD ON P.NUM_POKEDEX = PD.NUM_POKEDEX
WHERE P.CAJA = 1
