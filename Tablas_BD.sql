...
-- Si todavía no se han hecho los inserts, no crear la clave foránea
ALTER TABLE POKEDEX
...
NUM_OBJETO INT NOT NULL);
	...
	CONSTRAINT ID_ENTREANDOR_MOCHILA_FK FOREIGN KEY (ID_ENTREANDOR) REFERENCES ENTRENADOR,
	CONSTRAINT ID_OBJETO_MOCHILA_FK FOREIGN KEY (ID_OBJETO) REFERENCES OBJETO);
